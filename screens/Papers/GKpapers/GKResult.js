...
export default function GKResult(props){
    ...
    const getData = async ()=>{
        ...
        const marking = await AsyncStorage.getItem('gkExamMarking');
    ...
    const gotoAnswers = () =>{
        props.navigation.navigate('GK Answers');
    }
    ...
    return(
        <View>
            <ScrollView showsVerticalScrollIndicator={false}>
                {isLoading?false : <View style={styles.div2}>
