...
export default function GKTestDetails(props){
    ...
    const startExam = ()=>{
        props.navigation.navigate('GK Exam');
    }
        ...
        <View style={styles.container}>
            {isLoading?false: <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.eventBoardHeading}>
                    <Text style={styles.eventBoardText}>Welcome to Online Exam for GK test.</Text>
                </View>
                <Divider style={styles.divider2} />
                <View style={styles.temp}>
                    <View style={styles.eventContainer}>
                    <View style={styles.eventWrapper}>
                        <Text style={styles.eventTitle}>GK Paper Instructions</Text>
                    </View>
                    <Divider style={styles.divider1} />
                    <View style={styles.eventDetailsWrapper}>
                        <Text style={styles.eventHeading} > - The Exam has 10 multiple-choice questions (MCQ) </Text>
